...
public class SuspectInspectorFrame extends JFrame {

    public SuspectInspectorFrame(SuspectFrame parent, Suspect suspect) {
        setTitle("Suspect Details");
        setSize(400, 300);
        ...
        area.setText(suspect.getSummary());

        JScrollPane scroll = new JScrollPane(area);

        JButton btnSendNote = UIStyle.createButton("Send Note to Suspects Window");
        ...
        btnSendNote.addActionListener(e -> {
            parent.appendLog("Inspector note: Reviewed suspect " + suspect.getName());
        });
