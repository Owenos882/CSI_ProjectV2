...
public class GuiltyFrame extends JFrame {

    public GuiltyFrame(Suspect s) {
        setTitle("Correct Conviction!");
        setSize(400, 250);
        UIStyle.styleFrame(this);

        JLabel emoji = new JLabel("✔");
        emoji.setFont(new Font("Segoe UI", Font.BOLD, 90));
        emoji.setForeground(new Color(0, 180, 0));
        emoji.setHorizontalAlignment(SwingConstants.CENTER);

        JLabel title = UIStyle.createTitleLabel("Correct!");
        JLabel msg = UIStyle.createSubtitleLabel(s.getName() + " was guilty.");
